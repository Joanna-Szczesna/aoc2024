...
3   9
3   3
Maybe the lists are only off by a small amount! To find out, pair up the levels and measure how far apart they are.
 Pair up the smallest number in the left list with the smallest number in the right list,
  then the second-smallest left number with the second-smallest right number, and so on.

Within each pair, figure out how far apart the two levels are; you'll need to add up all of those distances.
...
The next levels to pair up are 3 and 4, a distance of 1.
The fifth-smallest levels in each list are 3 and 5, a distance of 2.
...
The Historians can't agree on which group made the mistakes or how to read most of the Chief's handwriting,
 but in the commotion you notice an interesting detail: a lot of location IDs appear in both lists!
  Maybe the other levels aren't location IDs at all but rather misinterpreted handwriting.
